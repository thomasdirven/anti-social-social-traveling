    ...
    public class TripContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Trip>().HasData(
                 new Trip { Id = 1, City = "Barcelona", Country = "Spain", StartDate = new DateTime(2021, 7, 14), EndDate = new DateTime(2021, 7, 25), MinDays = 2, MaxDays = 5, TotalBudget = 550, Latitude = 41.3850639, Longtitude = 2.1734035 },
                 new Trip { Id = 2, City = "Paris", Country = "France", StartDate = new DateTime(2021, 7, 20), EndDate = new DateTime(2021, 8, 2), MinDays = 3, MaxDays = 8, TotalBudget = 550, Latitude = 48.856614, Longtitude = 2.3522219 },
                 new Trip { Id = 3, City = "Prague", Country = "Czech Republic", StartDate = new DateTime(2021, 7, 10), EndDate = new DateTime(2021, 8, 10), MinDays = 4, MaxDays = 7, TotalBudget = 550, Latitude = 50.0755381, Longtitude = 14.4378005 },
                 new Trip { Id = 4, City = "Cannes", Country = "France", StartDate = new DateTime(2021, 7, 6), EndDate = new DateTime(2021, 7, 17), MinDays = 3, MaxDays = 6, TotalBudget = 550, Latitude = 43.552847, Longtitude = 7.017369 },
